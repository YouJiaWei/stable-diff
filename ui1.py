...
layout = [  
      [sg.Column([
            ...
            [sg.Push(),sg.Image("onepiece06_chopper.png"),sg.Button('閉じる',size=(10,2),button_color=('#ffffff', '#e60033'),font=('Arial',12,"bold")),sg.Push()] ,
            # [sg.Listbox(values=sg.theme_list(), size=(20, 12), key='-LIST-', enable_events=True)]
            ], justification='c')]
            ]

# ウィンドウの生成
window = sg.Window('AI生成プログラム', layout)
