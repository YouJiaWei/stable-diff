...
with autocast(DEVICE):
    while True:
        ...
        #prompt = "8k, RAW photo, best quality, masterpiece, realistic, photo-realistic,smile, clear, professional lighting, beautiful face, best quality,ultra high res,(one woman only:1.4)"
        prompt = "(masterpiece,best quality:1.4),(8k,raw photo,photo realistic:1.2),(shiny skin),detailed skin,detailed face,detailed eyes,1girl,looking at viewer,extremely beautiful face,smile"
        n_prompt ="(worst quality,low quality:2),(painting,sketch,flat color),blurry face,monochrome,grayscale,ugly face,bad face,bad anatomy,deformed eyes,missing fingers,acnes,skin blemishes,nsfw,nude,nipples"
        ...
        #n_prompt="deformed mutated disfigured,NSFW, missing arms, 4 fingers, 6 fingers,extra_arms , mutated hands, bad anatomy, disconnected limbs, low quality, worst quality, out of focus, ugly,error, blurry, bokeh, Shoulder bag, bag, multiple arms, nsfw."
        #negativprompt = "human"
        ...
        for _ in range(num_generate): # 同条件で複数枚生成する
         ...
         image.save(f"data/src/real_woman/real_woman_{i}.jpg")
