...
with autocast(DEVICE):
    while True:
        ...
        prompt = "(masterpiece,best quality:1.4),(8k,raw photo,photo realistic:1.2),detailed skin,1boy,boy focus,extremely cool face"
        n_prompt = "(worst quality,low quality:2),(girl, lady, woman:1.2),(painting,sketch,flat color),monochrome,grayscale,ugly face,bad face,bad anatomy,deformed eyes,missing fingers,acnes,skin blemishes,nsfw,nude,nipples"
        #prompt = "masterpiece, best quality, japanese, ultra detailed,solo man, male focus, 8k, RAW photo, realistic, photo-realistic, clear"
