...
with autocast(DEVICE):
    while True:
        ...
        prompt = "masterpiece,high quality,highly,(kawaii princess:1.2),white glowing skin,(kawaii face with blush:1.2),SSS(anime:1.3),artstation,gorgeous background,centered composition,lim lighting,intense shadows"
        ...
        n_prompt="EasyNegative, deformed mutated disfigured, NSFW, missing arms, 4 fingers, 6 fingers,extra_arms , mutated hands, bad anatomy, disconnected limbs, low quality, worst quality, out of focus, ugly,error, blurry, bokeh, Shoulder bag, bag, multiple arms, nsfw."
        #negativprompt = "human"
        ...
        for _ in range(num_generate): # 同条件で複数枚生成する
         ...
         image.save(f"data/src/anime_woman/anime_woman_{i}.jpg")
