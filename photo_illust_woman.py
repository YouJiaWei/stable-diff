...
with autocast(DEVICE):
    while True:
        ...
        prompt = "masterpiece,high quality,highly,(kawaii princess:1.2),white glowing skin,(kawaii face with blush:1.2),hair accessory,detailed skin,detailed face,detailed eyes,gothic lolita costume,(anime:1.3),artstation,gorgeous background,centered composition,lim lighting,intense shadows"
        n_prompt = "(worst quality,low quality:2),(nsfw,nude,exposed skin,exposed chest,nipples,naked,bare navel),monochrome,grayscale,ugly face,bad face,bad anatomy,deformed eyes,missing fingers,acnes,skin blemishes"
        #prompt = "masterpiece,high quality,highly,(kawaii princess:1.2),white glowing skin,(kawaii face with blush:1.2),long waved hair,(cleavage breasts:1.1),open shoulders,gothic lolita glossy dress with ruffles,gorgeous jewelry accessories,(anime:1.3),artstation,gorgeous background,centered composition,lim lighting,intense shadows"
        #n_prompt = "deformed mutated disfigured lowres blurred repetitive double mutated hands bad hands missing hands extra hands liquid hands poorly drawn hands mutated fingers bad fingers missing fingers extra fingers liquid fingers poorly drawn fingers partial head bad face small face partial face bad eyes too big eyes bad eyebrows bad eyelashes bad nose missing nose bad mouth missing mouth open mouth bad ears thick lips chest pad bad legs missing legs extra legs bad arms missing arms extra arms low quality normal quality crown black and white"
        #n_prompt="EasyNegative,NSFW, deformed mutated disfigured, missing arms, 4 fingers, 6 fingers,extra_arms , mutated hands, bad anatomy, disconnected limbs, low quality, worst quality, out of focus, ugly,error, blurry, bokeh, Shoulder bag, bag, multiple arms, nsfw."
        #negativprompt = "human"
        ...
        guidance_scale = 10
        strength = 0.4 #Denoising strength
        num_generate = 1
        ...
        for _ in range(num_generate): # 同条件で複数枚生成する
         ...
         image.save(f"data/src/illust_woman/illust_woman_{i}.jpg")
