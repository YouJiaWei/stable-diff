...
with autocast(DEVICE):
    while True:
        ...
        prompt = "masterpiece,high quality,highly, ultra detailed,  An anime boy, male focus,(super fine illustration:2.0),detailed skin,detailed face,detailed eyes,"
        n_prompt = "(girl, lady, woman:1.2),(worst quality,low quality:2),(painting,sketch,flat color),(nsfw,nude,exposed skin,exposed chest,nipples,naked,bare navel),monochrome,grayscale,ugly face,bad face,bad anatomy,deformed eyes,missing fingers,acnes,skin blemishes"
        ...
        for _ in range(num_generate): # 同条件で複数枚生成する
            ...
            image.save(f"data/src/anime_man/anime_man_{i}.jpg")
