...
from kaolin.models.PointNet2 import DPM
import cv2
import sys
...
scheduler = DPM.from_pretrained(MODEL_ID, subfolder="scheduler")
pipe = DPM.from_pretrained(
    MODEL_ID,
    scheduler=scheduler,
...
i = 0
popup = sg.popup_no_wait("AI画像生成中です・・・・・・", title="AI画面生成")
with autocast(DEVICE):
    while True:
        ...
        #negativprompt = "human"
        init_image_file = "C:/Users/Systena/Desktop/code/data/temp/camera_0.jpg" # 入力画像のパスを入力
